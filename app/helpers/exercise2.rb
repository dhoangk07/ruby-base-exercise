=begin
Exercise 5: English Numerals
Create Ruby code to translate a number to its English-language form. (for all integers less than 10^72)
For example:
7 == seven
42 == forty-two
...
def read_3_digits(x)
  length_number_digits = x.to_s.split("").length
  if length_number_digits== 1
    read_1_digits(x)
  elsif length_number_digits == 2
    read_2_digits(x)
  else
